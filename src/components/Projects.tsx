...
function WebsiteCard({ project }: { project: typeof projects[0] }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="group block relative rounded-3xl bg-gradient-to-br from-cream-dark to-cream overflow-hidden border border-charcoal/10 hover:border-accent/30 transition-all hover:-translate-y-1 cursor-pointer"
    >
      {/* Screenshot area */}
      <div className="relative h-56 md:h-64 overflow-hidden bg-gradient-to-br from-cream-dark to-cream">
        {project.screenshot ? (
          <img
            src={project.screenshot}
            alt={`${project.title} screenshot`}
      ...
      {/* Content */}
      <div className="p-6">
        <h3 className="text-xl font-bold text-charcoal mb-2 group-hover:text-accent transition-colors">
          {project.title}
        </h3>
...
function ProjectCard({ project }: { project: typeof projects[0] }) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="group block relative rounded-3xl bg-gradient-to-br from-cream-dark/80 to-cream-dark/30 p-6 md:p-8 border border-charcoal/5 hover:border-accent/20 transition-all hover:-translate-y-1 cursor-pointer"
    >
      {/* Category badge */}
      <div className="flex items-center justify-between mb-6">
        ...
        {project.links.github && (
          <span className="flex items-center gap-1.5 text-xs text-charcoal/50 font-medium">
