export const personalInfo = {
  ...
  about: {
    short: "Senior Android Engineer with 8+ years of experience building products used by millions. Passionate about clean architecture, great UX, and helping teams ship faster.",
    long: [
      "I'm a Senior Android Engineer who loves building products that people actually enjoy using. Over the past 8+ years, I've had the privilege of working with amazing teams at Medium, Yubo, and BlaBlaCar.",
  ...
  social: {
    ...
    linkedin: "https://linkedin.com/in/pierrickcaen",
    twitter: "https://twitter.com/pierrickcaen",
    medium: "https://medium.com/@pierrickcaen"
  },
